...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  { title: 'Liquiditaetsplanung', slug: 'liquiditaetsplanung', level: 'company', excerpt: 'Budget, Plan und Ist-Werte in der Liquiditaetsuebersicht.', tags: ['liquiditaet','budget','plan'], readingTimeMinutes: 6 },
  ...
  { title: 'Benutzer verwalten', slug: 'benutzer-verwalten', level: 'company', excerpt: 'Benutzer anlegen, Rollen zuweisen, Passwoerter zuruecksetzen.', tags: ['benutzer','rollen','einladung'], readingTimeMinutes: 5 },
  ...
  { title: 'Leitfaden / Anrufskript', slug: 'leitfaden', level: 'company', excerpt: 'Anrufskripte erstellen und KI-gestuetzt pruefen.', tags: ['skript','leitfaden','anruf'], readingTimeMinutes: 4 },
  { title: 'Finanzplanung — Uebersicht', slug: 'finanzplanung-uebersicht', level: 'company', excerpt: 'Rechnungsverarbeitung, Validierung und Zahlungsplanung.', tags: ['finanzplanung','rechnung','zahlung'], readingTimeMinutes: 7 },
  { title: 'Finanzplanung — Rechnungseingang', slug: 'finanzplanung-eingang', level: 'company', excerpt: 'Eingehende Rechnungen pruefen, validieren und genehmigen.', tags: ['rechnung','validierung','genehmigung'], readingTimeMinutes: 8 },
  { title: 'Finanzplanung — Zahlungsplanung', slug: 'finanzplanung-planung', level: 'company', excerpt: 'Cash-out terminieren, Zahlungslaeufe erstellen und freigeben.', tags: ['zahlung','planung','cashout'], readingTimeMinutes: 7 },
  ...
  { title: 'Prozessvorlagen hochladen', slug: 'prozessvorlagen', level: 'company', excerpt: 'JSON-Vorlagen fuer Prozesse hochladen und verwalten.', tags: ['prozess','vorlage','template','json'], readingTimeMinutes: 4 },
  ...
  { title: 'Prozess-Builder', slug: 'prozess-builder', level: 'holding', excerpt: 'Geschaeftsprozesse entwerfen, Schritte definieren und deployen.', tags: ['prozess','builder','workflow'], readingTimeMinutes: 8 },
  ...
  { title: 'Compliance und Zertifizierungen', slug: 'compliance', level: 'holding', excerpt: 'Compliance-Regeln, Pruefungen und Zertifizierungen verwalten.', tags: ['compliance','zertifizierung','audit'], readingTimeMinutes: 6 },
