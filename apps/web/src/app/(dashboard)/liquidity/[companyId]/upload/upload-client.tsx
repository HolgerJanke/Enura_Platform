...
// ---------------------------------------------------------------------------
// Upload Client (rendered by the server `page.tsx`, which enforces the
// module:finance:read permission before this client component ever loads)
// ---------------------------------------------------------------------------

export function BankUploadClient() {
