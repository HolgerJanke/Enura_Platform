...
//
// The Enura cross-holding `EnuraAddonsClient` that used to live here was
// moved to `apps/web/src/app/platform/addons/addons-client.tsx` (finding
// C5), alongside its relocated Enura-only page and action.
// ---------------------------------------------------------------------------
