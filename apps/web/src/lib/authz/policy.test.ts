...
const ROLE_PERMS: Record<string, string[]> = {
  ...
  setter: ['module:setter:read', 'module:leads:read'],
  berater: ['module:berater:read', 'module:leads:read'],
  innendienst: ['module:innendienst:read', 'module:innendienst:write', 'module:bau:read', 'module:leads:read'],
...
const EXPECTED: Record<string, string[]> = {
  ...
  '/leads': ['super_user', 'geschaeftsfuehrung', 'teamleiter', 'setter', 'berater', 'innendienst', 'leadkontrolle'],
  ...
  '/anomalies': ['super_user', 'geschaeftsfuehrung', 'teamleiter'],
