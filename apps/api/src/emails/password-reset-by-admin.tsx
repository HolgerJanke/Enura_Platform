...
export function PasswordResetByAdminEmail({
  ...
  tempPassword,
  primaryColor,
}: PasswordResetByAdminEmailProps) {
  return (
    <Html lang="de">
      <Head />
      <Preview>
        ...
        <Container style={container}>
          ...
          <Section style={contentSection}>
            ...
            <Text style={paragraph}>
              Ihr Passwort wurde von einem Administrator zurueckgesetzt. Bitte
              melden Sie sich mit dem neuen temporaeren Passwort an.
            </Text>

            <Text style={paragraph}>Melden Sie sich hier an:</Text>
            ...
            <Text style={labelText}>Ihr neues temporaeres Passwort:</Text>
            ...
            <Section style={warningBox}>
              <Text style={warningText}>
                ...
                naechsten Anmeldung aufgefordert, ein neues Passwort zu
                vergeben.
              </Text>
            </Section>
            ...
            <Section style={alertBox}>
              <Text style={alertText}>
                Falls Sie diese Aenderung nicht erwartet haben, kontaktieren Sie
                sofort Ihren Administrator.
              </Text>
            </Section>
          </Section>
          ...
          <Section style={footerSection}>
            <Text style={footerText}>
              Bei Fragen oder Problemen wenden Sie sich an Ihren Vorgesetzten
...
export default PasswordResetByAdminEmail
