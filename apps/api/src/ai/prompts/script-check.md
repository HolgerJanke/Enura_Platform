  ...
  "script_steps": [
    {
      ...
      "status": "erfüllt" | "teilweise" | "ausgelassen",
...
- "erfüllt" bedeutet: Der Schritt wurde inhaltlich korrekt und vollständig umgesetzt, auch wenn die Wortwahl leicht abweicht.
