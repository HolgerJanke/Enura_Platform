export const de: Record<string, string> = {
  ...
  'action.select': 'Auswaehlen',
  'action.selectAll': 'Alle auswaehlen',
  'action.deselectAll': 'Alle abwaehlen',
  ...
  'auth.resetPasswordDescription': 'Bitte setzen Sie Ihr Passwort zurueck, bevor Sie fortfahren.',
  ...
  'auth.unauthorized': 'Sie haben keine Berechtigung fuer diese Aktion.',
  'auth.forbidden': 'Zugriff verweigert.',
  'auth.passwordChanged': 'Passwort erfolgreich geaendert.',
  ...
  'module.leads.description': 'Lead-Eingang, Qualitaet und Bearbeitungsstatus.',
  'module.innendienst.title': 'Innendienst / Planung',
  'module.innendienst.description': 'Offene Planungsauftraege, IA-Status und blockierte Projekte.',
  'module.projects.title': 'Bau & Montage',
  'module.projects.description': '27-Phasen-Kanban fuer Projekte von Auftragseingang bis Abnahme.',
  'module.finance.title': 'Finanzen & Cashflow',
  'module.finance.description': 'Umsatz, offene Forderungen, Liquiditaetsprognose und Cashflow.',
  ...
  'module.reports.description': 'Taegliche KI-Berichte und individuelle Auswertungen.',
  'module.holding.title': 'Holding Dashboard',
  'module.holding.description': 'Ueberblick ueber alle Gesellschaften der Enura Group.',
  ...
  'kpi.setter.callQualityScore': 'KI-Anrufqualitaet',
  'kpi.setter.greetingScore': 'Begruessung',
  'kpi.setter.needsAnalysisScore': 'Bedarfsanalyse',
  'kpi.setter.presentationScore': 'Praesentation',
  ...
  'kpi.berater.activitiesDay': 'Aktivitaeten/Tag',
  ...
  'kpi.leads.qualityRate': 'Lead-Qualitaetsrate',
  ...
  // ---------------------------------------------------------------------------
  'kpi.innendienst.openOrders': 'Offene Planungsauftraege',
  ...
  'kpi.finance.overdueInvoices': 'Ueberfaellige Rechnungen',
  'kpi.finance.weeklyPayments': 'Zahlungseingaenge/Woche',
  'kpi.finance.liquidityForecast30': 'Liquiditaet 30 Tage',
  'kpi.finance.liquidityForecast60': 'Liquiditaet 60 Tage',
  'kpi.finance.liquidityForecast90': 'Liquiditaet 90 Tage',
  ...
  'form.dueDate': 'Faelligkeitsdatum',
  'form.status': 'Status',
  'form.source': 'Quelle',
  'form.team': 'Team',
  'form.role': 'Rolle',
  ...
  'validation.passwordMatch': 'Die Passwoerter stimmen nicht ueberein.',
  'validation.passwordRequirements': 'Das Passwort muss Gross-/Kleinbuchstaben, Zahlen und Sonderzeichen enthalten.',
  'validation.invalidPhone': 'Bitte geben Sie eine gueltige Telefonnummer ein.',
  'validation.invalidZip': 'Bitte geben Sie eine gueltige Postleitzahl ein.',
  'validation.invalidAmount': 'Bitte geben Sie einen gueltigen Betrag ein.',
  'validation.invalidDate': 'Bitte geben Sie ein gueltiges Datum ein.',
  'validation.futureDate': 'Das Datum muss in der Zukunft liegen.',
  'validation.pastDate': 'Das Datum muss in der Vergangenheit liegen.',
  'validation.invalidUrl': 'Bitte geben Sie eine gueltige URL ein.',
  'validation.invalidColor': 'Bitte geben Sie einen gueltigen Hex-Farbwert ein.',
  'validation.fileTooBig': 'Die Datei ist zu gross. Maximal {max} MB erlaubt.',
  'validation.invalidFileType': 'Dieser Dateityp wird nicht unterstuetzt.',
  ...
  'validation.totpInvalid': 'Der eingegebene Code ist ungueltig.',
  ...
  'invoice.status.overdue': 'Ueberfaellig',
  ...
  'error.network': 'Netzwerkfehler. Bitte pruefen Sie Ihre Internetverbindung.',
  ...
  'error.serverError': 'Serverfehler. Bitte versuchen Sie es spaeter erneut.',
  'error.validationFailed': 'Die eingegebenen Daten sind ungueltig.',
  'error.saveError': 'Beim Speichern ist ein Fehler aufgetreten.',
  'error.deleteError': 'Beim Loeschen ist ein Fehler aufgetreten.',
  ...
  'error.fileTooLarge': 'Die Datei ist zu gross.',
  'error.invalidFileFormat': 'Ungueltiges Dateiformat.',
  'error.brandingInvalid': 'Die Branding-Konfiguration ist ungueltig. Bitte pruefen Sie die Eingaben.',
  'error.passwordResetRequired': 'Sie muessen Ihr Passwort zuruecksetzen, bevor Sie fortfahren koennen.',
  ...
  'empty.leadsFiltered': 'Keine Leads fuer die aktuelle Filterauswahl.',
  'empty.offers': 'Keine Offerten vorhanden.',
  'empty.offersFiltered': 'Keine Offerten fuer die aktuelle Filterauswahl.',
  'empty.calls': 'Keine Anrufe vorhanden.',
  'empty.callsFiltered': 'Keine Anrufe fuer die aktuelle Filterauswahl.',
  'empty.invoices': 'Keine Rechnungen vorhanden.',
  'empty.invoicesFiltered': 'Keine Rechnungen fuer die aktuelle Filterauswahl.',
  'empty.projects': 'Keine Projekte vorhanden.',
  'empty.projectsFiltered': 'Keine Projekte fuer die aktuelle Filterauswahl.',
  ...
  'empty.auditLog': 'Keine Audit-Eintraege vorhanden.',
  'empty.teamMembers': 'Keine Teammitglieder vorhanden.',
  'empty.reports': 'Keine Berichte vorhanden.',
  'empty.cashflow': 'Keine Cashflow-Eintraege vorhanden.',
  'empty.calendar': 'Keine Kalendereintraege vorhanden.',
  'empty.analysis': 'Keine Analyse vorhanden.',
  'empty.notifications': 'Keine Benachrichtigungen.',
  'empty.search': 'Keine Ergebnisse fuer Ihre Suche.',
  ...
  'table.page': 'Seite',
  'table.showing': 'Zeige',
  'table.entries': 'Eintraege',

  // ---------------------------------------------------------------------------
  // 27-Phase Kanban — Bau & Montage
  // ---------------------------------------------------------------------------
  'phase.1': 'Auftrag eingegangen',
  'phase.2': 'Auftragsbestaetigung',
  'phase.3': 'Technische Abklaerung',
  ...
  'phase.11': 'Geruest bestellt',
  'phase.12': 'Geruest aufgestellt',
  'phase.13': 'DC-Montage geplant',
  'phase.14': 'DC-Montage abgeschlossen',
  'phase.15': 'AC-Montage geplant',
  'phase.16': 'AC-Montage abgeschlossen',
  'phase.17': 'Waermepumpe geplant',
  'phase.18': 'Waermepumpe installiert',
  'phase.19': 'Elektroinstallation',
  'phase.20': 'Inbetriebnahme geplant',
  'phase.21': 'Inbetriebnahme durchgefuehrt',
  'phase.22': 'Geruest abgebaut',
  'phase.23': 'Abnahme geplant',
  'phase.24': 'Abnahme durchgefuehrt',
  ...
  'ui.modifiedBy': 'Geaendert von',

  // ---------------------------------------------------------------------------
  // Confirm dialogs
  // ---------------------------------------------------------------------------
  'confirm.delete': 'Sind Sie sicher, dass Sie diesen Eintrag loeschen moechten?',
  'confirm.deleteTitle': 'Eintrag loeschen',
  'confirm.deleteDescription': 'Diese Aktion kann nicht rueckgaengig gemacht werden.',
  'confirm.deactivate': 'Sind Sie sicher, dass Sie diesen Benutzer deaktivieren moechten?',
  'confirm.deactivateTitle': 'Benutzer deaktivieren',
  'confirm.resetPassword': 'Soll das Passwort fuer diesen Benutzer zurueckgesetzt werden?',
  'confirm.resetPasswordTitle': 'Passwort zuruecksetzen',
  'confirm.disconnect': 'Soll die Verbindung zu diesem Konnektor getrennt werden?',
  'confirm.disconnectTitle': 'Konnektor trennen',
  'confirm.unsavedChanges': 'Sie haben ungespeicherte Aenderungen. Moechten Sie die Seite wirklich verlassen?',
  'confirm.unsavedChangesTitle': 'Ungespeicherte Aenderungen',

  // ---------------------------------------------------------------------------
  // Success messages
  // ---------------------------------------------------------------------------
  'success.saved': 'Erfolgreich gespeichert.',
  'success.deleted': 'Erfolgreich geloescht.',
  ...
  'success.passwordReset': 'Passwort wurde zurueckgesetzt.',
  ...
  'role.geschaeftsfuehrung': 'Geschaeftsfuehrung',
  ...
  'report.recipients': 'Empfaenger',

  // ---------------------------------------------------------------------------
  // Branding settings
  // ---------------------------------------------------------------------------
  'branding.primaryColor': 'Primaerfarbe',
  'branding.secondaryColor': 'Sekundaerfarbe',
  'branding.accentColor': 'Akzentfarbe',
  'branding.backgroundColor': 'Hintergrundfarbe',
  'branding.surfaceColor': 'Oberflaechenfarbe',
  'branding.textPrimary': 'Primaere Textfarbe',
  'branding.textSecondary': 'Sekundaere Textfarbe',
  ...
  'users.resetPassword': 'Passwort zuruecksetzen',
  'users.temporaryPassword': 'Temporaeres Passwort',
  'users.active': 'Aktiv',
  'users.inactive': 'Inaktiv',
  'users.lastLogin': 'Letzter Login',
  'users.twoFactorStatus': '2FA-Status',
  'users.passwordStatus': 'Passwort-Status',
  'users.mustResetPassword': 'Muss Passwort aendern',
  ...
  'connectors.addConnector': 'Konnektor hinzufuegen',
  ...
  'connectors.nextSync': 'Naechste Synchronisation',
  'connectors.recordsSynced': 'Synchronisierte Datensaetze',
  ...
  'holding.tenantSlug': 'Subdomain',
  'holding.tenantName': 'Firmenname',
  ...
  'holding.crossCompanyAnalytics': 'Unternehmensuebergreifende Analysen',
