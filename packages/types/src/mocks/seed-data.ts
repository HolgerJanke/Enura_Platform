...
const leadData: Array<{
  ...
  { first: 'Peter', last: 'Wenger', email: 'p.wenger@sunrise.ch', phone: '+41 79 300 0003', street: 'Freie Straße 45', zip: '4001', city: 'Basel', canton: 'BS', status: 'qualified', source: 'advertising', setterId: teamMemberId(1), notes: 'W\u00e4rmepumpe + PV Kombiangebot gew\u00fcnscht' },
...
const projectData: Array<{
  ...
  { title: 'PV 8 kWp Wenger', customer: 'Peter Wenger', street: 'Freie Straße 45', zip: '4001', city: 'Basel', phaseIdx: 27, status: 'completed', offerIdx: null, beraterIdx: 4, leadIdx: 3, installDate: '2026-02-20', notes: 'Projekt erfolgreich abgeschlossen' },
...
export const connectors: ConnectorRow[] = [
  ...
  },
  {
    ...
    name: 'Telefonie',
    credentials: {},
    config: { webhook_url: 'https://api.example.com/webhooks/telephony' },
    status: 'active',
    last_synced_at: '2026-03-23T09:45:00.000Z',
    last_error: null,
    sync_interval_minutes: 15,
  ...
  },
  {
    ...
    name: 'Kalender',
    credentials: {},
    config: { calendars: ['team@example.com'] },
    status: 'active',
    last_synced_at: '2026-03-23T09:45:00.000Z',
    last_error: null,
    sync_interval_minutes: 15,
